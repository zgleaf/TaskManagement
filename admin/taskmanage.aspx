...
<body>
    ...
    <div>
        ...
        <asp:TextBox ID="TB_reponse" runat="server" Width="78px"></asp:TextBox>&nbsp;<asp:Button
            ID="Btn_Search" runat="server" Text="Search" />&nbsp;
        <asp:Button ID="Btn_Clear" runat="server" Text="Clear" /></div>
        <asp:GridView ID="TaskView" runat="server" AutoGenerateColumns="False" DataKeyNames="id"
            DataSourceID="TaskMgr" Height="379px" AllowPaging="True" AllowSorting="True" AutoGenerateDeleteButton="True" AutoGenerateEditButton="True" CellPadding="4" ForeColor="#333333" GridLines="None" PageSize="100">
            <Columns>
