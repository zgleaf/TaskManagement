<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="taskmanage.aspx.vb" Inherits="TastManagement.dbmanager" %>
...
<body>
    ...
    <div>
        ...
        <asp:GridView ID="TaskView" runat="server" AutoGenerateColumns="False" DataKeyNames="id"
            DataSourceID="TaskMgr" Height="379px" AllowPaging="True" AllowSorting="True" AutoGenerateDeleteButton="True" AutoGenerateEditButton="True" AutoGenerateSelectButton="True" CellPadding="4" ForeColor="#333333" GridLines="None">
            <Columns>
