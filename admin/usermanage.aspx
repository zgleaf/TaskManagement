...
<body>
    ...
    <div>
        ...
        <asp:GridView ID="UserView" runat="server" AllowPaging="True" AllowSorting="True"
            ...
            Width="466px" AutoGenerateDeleteButton="True" AutoGenerateEditButton="True" AutoGenerateSelectButton="True" DataMember="DefaultView" CellPadding="4" ForeColor="#333333" GridLines="None">
            <Columns>
