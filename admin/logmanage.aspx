...
<body>
    ...
    <div>
        ...
        <asp:GridView ID="LogView" runat="server" AutoGenerateColumns="False"
            DataSourceID="TaskMgr" Height="387px" AllowPaging="True" AllowSorting="True" AutoGenerateDeleteButton="True" CellPadding="4" ForeColor="#333333" GridLines="None" Width="694px" DataKeyNames="id">
            <Columns>
